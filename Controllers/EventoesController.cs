...
namespace ProySalonDeEventos.Controllers
{
    public class EventoesController : Controller
    {
        ...
        public EventoesController(SalonDatabaseContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEvento,nombre,musica,decoracion,catering,tipo")] Evento evento)
        {
