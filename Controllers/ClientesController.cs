...
namespace ProySalonDeEventos.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public ClientesController(SalonDatabaseContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCliente,nombre,mail,telefono,cuit,direccion,pass,user")] Cliente cliente)
        {
